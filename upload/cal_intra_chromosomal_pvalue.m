    ...
    if temprow1>20 && temprow2>20
        for j=1:temprow1
            ...
            for jj=1:temprow2
                ...
                if genecoordination(binding2knockout_refined{i}{1}(j,1),2)==genecoordination(binding2knockout_refined{i}{2}(jj,1),2) && gene2gene_intra(binding2knockout_refined{i}{1}(j,1),binding2knockout_refined{i}{2}(jj,1))==1 && abs(genecoordination(binding2knockout_refined{i}{1}(j,1),3)-genecoordination(binding2knockout_refined{i}{2}(jj,1),3))>60000
                    ind=1;
                end
            end
            if ind==1
        ...
        for j=1:temprow2
            ...
            for jj=1:temprow1
                ...
                if genecoordination(binding2knockout_refined{i}{2}(j,1),2)==genecoordination(binding2knockout_refined{i}{1}(jj,1),2) && gene2gene_intra(binding2knockout_refined{i}{2}(j,1),binding2knockout_refined{i}{1}(jj,1))==1 && abs(genecoordination(binding2knockout_refined{i}{2}(j,1),3)-genecoordination(binding2knockout_refined{i}{1}(jj,1),3))>60000
                    ind=1;
                end
            end
            if ind==1
...
save('binding2knockout_Reimand3.mat','binding2knockout','binding2knockout_refined','result','binding2knockout_refined_ind','binding2knockout_hicpair');
%see varialble 'result' for the 5th column represents the frequency of pairs between TF and its bound genes that show intra-chromosomal colocalization with genes whose expression were affected by knockout of the corresponding TF; the 6th column represents the frequency of TF-KO genes showing intra-chromosomal colocalization with TF bound genes
        ...
        if temprow1>20 && temprow2>20
            for j=1:temprow1
                ...
                for jj=1:temprow2
                    ...
                    if genecoordination(random_genes{iii}{i}{1}(j,1),2)==genecoordination(random_genes{iii}{i}{2}(jj,1),2) && gene2gene_intra(random_genes{iii}{i}{1}(j,1),random_genes{iii}{i}{2}(jj,1))==1 && abs(genecoordination(random_genes{iii}{i}{1}(j,1),3)-genecoordination(random_genes{iii}{i}{2}(jj,1),3))>60000
                        ind=1;
                    end
                end
                if ind==1
            ...
            for j=1:temprow2
                ...
                for jj=1:temprow1
                    ...
                    if genecoordination(random_genes{iii}{i}{1}(jj,1),2)==genecoordination(random_genes{iii}{i}{2}(j,1),2)  && gene2gene_intra(random_genes{iii}{i}{1}(jj,1),random_genes{iii}{i}{2}(j,1))==1 && abs(genecoordination(random_genes{iii}{i}{1}(jj,1),3)-genecoordination(random_genes{iii}{i}{2}(j,1),3))>60000
                        ind=1;
                    end
                end
                if ind==1
...
save('random_binding2knockout_Reimand6.mat','result');
...
result1=result;
load('random_binding2knockout_Reimand6.mat');%10,000 randomized experiments
...
% The 1st column represents the P value of pairs between TF and its bound genes that show intra-chromosomal colocalization with genes whose expression were affected by knockout of the corresponding TF; The 2nd column represents the P value of TF-KO genes showing intra-chromosomal colocalization with TF bound genes
